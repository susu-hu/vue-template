  ...
  <div class="calendar">
    ...
    >
        ...
        >
          ...
          >
            <li
              ...
              :style="(`height: ${itemHeight}px`, `color:${theme_color}`)"
              @click="checkoutDate(item)"
            >
              <span
                class="data-font calendar-item"
                :style="{ background: item.isSelected ? theme_color : '' }"
                >{{ item.day }}</span
              >
            </li>
          </ul>
      ...
      >
        ...
        >
          <div class="touch-item" :style="{ background: theme_color }"></div>
        </div>
      </section>
    </section>
  </div>
