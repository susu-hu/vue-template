 ...
 * @Date: 2022-07-12 20:34:03
 * @LastEditors: 胡苏珍 1628469970@qq.com
 * @LastEditTime: 2022-07-12 20:57:51
 * @FilePath: \control-platform-vue\src\view\threePosition\components\rightCenterHead.vue
...
.content {
  .head {
    ...
    .u-value {
      ...
      color: #ffa354;
      line-height: 27px;
      text-shadow: 0px 0px 2px rgba(255, 163, 84, 0.59),
